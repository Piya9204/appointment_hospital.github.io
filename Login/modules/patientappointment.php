...
<div class="wrapper col4">
    <div id="container">
        ...
        if(isset($_POST[submit]))
        {
         ...
         {
             echo "<h2 class='text-center'>Appointment taken successfully.. </h2>";
             echo "<p class='text-center'>Appointment record is in pending process. Please wait for confirmation.. </p>";
                        ...
                        <div class="col-lg-7">
                            ...
                            ?>
                             ...
                             ?>
                                        ...
                                        <li class="col-sm-12">
                                            <button type="submit" style="background-color: #e12454" class="btn btn-icon btn-round-full ntn-main" name="submit" id="submit">Book an appointment</button>
                                        </li>
                                </form>
                            </div>
                        </div>
