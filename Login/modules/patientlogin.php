...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>Hospital Appointment System</span>Login <span class="msg">Hello, Patient!</span></h1>
        <div class="col-md-12">
    ...
    <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
                ...
                <div>
                    ...
                    <div class="text-center"> <a href="patient.php">Registe Here</a></div>
